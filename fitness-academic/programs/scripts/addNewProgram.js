      ...
      <div class="col-sm order-2">
        <div class="row">
          ...
          <div class="col-sm-12 order-3 d-flex justify-content-end">
            <input type="text" class="form-control yekan-bakh set-input input-set" data-index="${index}" data-label="sets" placeholder="تعداد ست">
          </div>
        </div>
      </div>
      <div class="col-sm order-2">
        <div class="row">
          ...
          <div class="col-sm-12 order-3 d-flex justify-content-end">
            <input type="text" class="form-control yekan-bakh repeat-input input-set" data-index="${index}" data-label="reps" placeholder="تعداد تکرار">
          </div>
        </div>
      </div>
    </div>
...
document.getElementById('addItemToDietContainer').addEventListener('click', ()=>{
    ...
    addItemDiet(dietFormData.length)
});
